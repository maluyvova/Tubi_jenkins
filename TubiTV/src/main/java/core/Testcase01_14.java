...
public class Testcase01_14 extends Main implements  URL, Xpath,data,Data_for_user {
	
	
	public static String TestCase01_14 () throws InterruptedException, IOException {
		driver=br();
		driver.get(URL.url);
		...
		testc(Xpath.year);
		testc(Xpath.orange_register);
		screenshoot("/Users/maluy/eclipse-workspace/TubiTV/Screenshots/TestCase01_14.png");
