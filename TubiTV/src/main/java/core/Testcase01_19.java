...
public class Testcase01_19 extends Main implements  URL, Xpath,data,Data_for_user




{
	public static String TestCase01_19 () throws InterruptedException, IOException{
		driver=br();
		driver.get(URL.url);
		testc(Xpath.sign_in);
		testc(Xpath.register_up);
		...
		screenshoot("/Users/maluy/eclipse-workspace/TubiTV/Screenshots/TestCase01_19.png");
		Thread.sleep(4000);
