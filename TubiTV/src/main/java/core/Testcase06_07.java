...
public class Testcase06_07  extends Main implements  URL, Xpath,data,Data_for_user {

			
			public static String TestCase06_07() throws InterruptedException, IOException{
			driver=br();
			  driver.get(URL.url);
			  ...
			  testc(Xpath.register); // click on register on the right upper corner
				...
				testc(Xpath.orange_register);  //click on register button
				  ...
				  Thread.sleep(4000);
			        ...
			        testc("//button[@class='NewBrandButton NewBrandButton--secondary']"); //select "Skip"
			     	screenshoot("/Users/maluy/eclipse-workspace/TubiTV/Screenshots/TestCase06_07.png");
