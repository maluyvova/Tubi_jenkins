...
public class Testcase06_10 extends Main implements  URL, Xpath,data,Data_for_user{

	
	public static boolean TestCase06_10() throws InterruptedException, IOException{
		  driver=br();
		  driver.get(URL.url);
